...
if($worked!=1){
  ...
  echo '<p>Please enter the following information to login; if you have a compound last name like Smith-Jones, please enter it as Smithjones.</p>';
  ...
  if (!empty($instructor_email)){
    echo "<hr>";
echo '<p>Your course grade is calculated by the formula $$CG=H+0.5(M_1+M_2)+0.3F,$$ where $H \in [0,30]$ is the homework grade (lowest dropped), $M_1,M_2 \in [0,40]$ are the two midterm grades, and $F \in [0,100]$ is the final exam grade.   
  </p>';
    echo "<hr>";
    echo "<p> $problems";
